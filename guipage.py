...
def search():
    ...
    querySQL = str("SELECT short_name FROM playerprofile")
...
#PLAYER CHARACTERISTICS PAGE
    ...
    if whereStatement: #LETS DO THE JOIN HERE
        join1Done=True
        querySQL = querySQL[0:36]+" join playercharacteristics pc on pc.id=playerprofile.id"+querySQL[36:]+" AND potential>=" + str(potential_scale.get()) + " AND pace>=" + str(pace_scale.get()) + " AND dribbling>=" + str(dribbling_scale.get()) + " AND defending>=" + str(defending_scale.get())+ " AND pace>=" + str(pace_scale.get()) + " AND physic>=" + str(physic_scale.get()) + " AND shooting>=" + str(shooting_scale.get()) + " AND goalkeeper>=" + str(gk_scale.get()) + " AND passing>=" + str(passing_scale.get())

    else:
        join1Done = True
        querySQL = querySQL[0:36] + " join playercharacteristics pc on pc.id=playerprofile.id" + querySQL[36:] + " WHERE potential>=" + str(potential_scale.get())+ " AND pace>=" + str(pace_scale.get()) + " AND dribbling>=" + str(dribbling_scale.get()) + " AND defending>=" + str(defending_scale.get()) + " AND pace>=" + str(pace_scale.get()) + " AND physic>=" + str(physic_scale.get()) + " AND shooting>=" + str(shooting_scale.get()) + " AND goalkeeper>=" + str(gk_scale.get()) + " AND passing>=" + str(passing_scale.get())
...
# search button
search_button1 = Button(frame1, text="SEARCH", command=search)
...
# search button 2
search_button2 = Button(frame2, text="SEARCH", command=search)
...
# search button 3
search_button3 = Button(frame3, text="SEARCH", command=search)
...
# search button 4
search_button4 = Button(frame4, text="SEARCH", command=search)
